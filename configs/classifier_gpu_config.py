...
CONFIG = {
    ...
    "SEED": 1,
    "USE_CUDA": True,             # set to True for gpu training
    "CUDNN_DETERMINISTIC": True,  # for repeating results together with SEED
    "CUDNN_BENCHMARK": True,      # set to True for faster training with gpu
    "GPU_DEVICE": [0,1],          # cuda device list for single/multi gpu training
    "USE_AMP": True,              # automatic mixed precision training for faster train
    "ARCH": {
        "TYPE": Classifier,
        "ARGS": {
